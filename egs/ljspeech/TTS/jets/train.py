    ...
    params = AttributeDict(
        {
            ...
            "lambda_var": 1.0,  # Loss scaling coefficient for variance loss
            "lambda_align": 1.0,  # loss scaling coefficient for alignment loss
        }
    )
...
def train_one_epoch(
    ...
    for batch_idx, batch in enumerate(train_dl):
        ...
        # NOTE: JETS requires that the generator is trained first.
