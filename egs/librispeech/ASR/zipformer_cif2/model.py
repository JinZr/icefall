...
class AsrModel(nn.Module):
    ...
    def forward_transducer(
        ...
        return simple_loss, ce_loss, cif_loss
    ...
    def forward(
        ...
        if self.use_transducer:
            # Compute transducer loss
            simple_loss, ce_loss, cif_loss = self.forward_transducer(
        ...
        return simple_loss, ce_loss, cif_loss, ctc_loss
