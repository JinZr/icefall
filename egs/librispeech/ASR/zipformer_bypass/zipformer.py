...
from squeeze_and_excite_bypass_module import SqueezeAndExciteBypassModule
...
class Zipformer2EncoderLayer(nn.Module):
    ...
    def __init__(
        ...
        self.bypass = SqueezeAndExciteBypassModule(
            embed_dim, skip_rate=bypass_skip_rate, straight_through_rate=0
        )
        # bypass_mid is bypass used in the middle of the layer.
        self.bypass_mid = SqueezeAndExciteBypassModule(
            embed_dim, straight_through_rate=0
        )
    ...
    def forward(
        ...
        src = self.bypass(src_orig, src, src_key_padding_mask)
...
class DownsampledZipformer2Encoder(nn.Module):
    ...
    def __init__(
        ...
        self.out_combiner = SqueezeAndExciteBypassModule(dim, straight_through_rate=0)
