...
class AsrModel(nn.Module):
    ...
    def forward_encoder(
        ...
        encoder_out, mid_encoder_out, padding_mask = self.encoder.extract_features(
            source=x,
        ...
        return encoder_out, mid_encoder_out, encoder_out_lens
    ...
    def forward(
        ...
        # Compute encoder outputs
        encoder_out, mid_encoder_out, encoder_out_lens = self.forward_encoder(x, padding_mask)

        mid_encoder_out = mid_encoder_out.permute(1, 0, 2)
        ...
        return mid_simple_loss, mid_pruned_loss, simple_loss, pruned_loss, ctc_loss, encoder_out_lens
