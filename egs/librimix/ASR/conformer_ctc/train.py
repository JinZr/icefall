...
def run(rank, world_size, args):
    ...
    train_cuts = librimix.train_all_shuf_cuts()
    ...
    train_dl = librimix.train_dataloaders(train_cuts)

    valid_cuts = librimix.dev_cuts()
    valid_dl = librimix.valid_dataloaders(valid_cuts)
