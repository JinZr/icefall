...
def get_parser():
    ...
    parser.add_argument(
        "--exp-dir",
        type=str,
        default="zipformer_mid_joiner_separate_predictor/exp",
...
def compute_loss(
    ...
    with torch.set_grad_enabled(is_training):
        mid_simple_loss, simple_loss, pruned_loss, _ = model(
            x=feature,
            x_lens=feature_lens,
            y=y,
        ...
        if params.use_mid_rnnt_loss:
            ...
            loss += (simple_loss_scale * mid_simple_loss) * params.mid_rnnt_loss_scale
