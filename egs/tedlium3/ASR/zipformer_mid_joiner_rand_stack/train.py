...
def get_transducer_model(params: AttributeDict) -> nn.Module:
    ...
    mid_joiners, joiner = get_joiner_model(params)
    ...
    model = AsrModel(
        ...
        decoder=decoder,
        joiner=joiner,
        mid_joiners=mid_joiners,
        mid_encoder_dims=_to_int_tuple(params.encoder_dim)[:-1],
...
def compute_loss(
    ...
    with torch.set_grad_enabled(is_training):
        mid_simple_loss, mid_pruned_loss, simple_loss, pruned_loss, _ = model(
            x=feature,
            x_lens=feature_lens,
            y=y,
