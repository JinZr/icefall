...
#      You can download them from https://www.openslr.org/19
#
#  - $dl_dir/musan
...
if [ $stage -le 0 ] && [ $stop_stage -ge 0 ]; then
  ...
  # If you have pre-downloaded it to /path/to/tedlium2,
  # you can create a symlink
  #
  # ln -sfv /path/to/tedlium2 $dl_dir/tedlium2
  #
  if [ ! -d $dl_dir/tedlium2 ]; then
    lhotse download tedlium2 $dl_dir
    mv $dl_dir/TEDLIUM_release2 $dl_dir/tedlium2
  fi
...
if [ $stage -le 1 ] && [ $stop_stage -ge 1 ]; then
  ...
  if [ ! -f data/manifests/.tedlium2.done ]; then
    # We assume that you have downloaded the tedlium2 corpus
    # to $dl_dir/tedlium2
    mkdir -p data/manifests
    lhotse prepare tedlium2 $dl_dir/tedlium2 data/manifests
...
if [ $stage -le 3 ] && [ $stop_stage -ge 3 ]; then
  ...
  if [ ! -e data/fbank/.tedlium2.done ]; then
    ...
    python3 ./local/compute_fbank_tedlium2.py

    gunzip -c data/fbank/tedlium2_cuts_train.jsonl.gz | shuf | \
    gzip -c > data/fbank/tedlium2_cuts_train-shuf.jsonl.gz
    mv data/fbank/tedlium2_cuts_train-shuf.jsonl.gz \
       data/fbank/tedlium2_cuts_train.jsonl.gz
...
if [ $stage -le 5 ] && [ $stop_stage -ge 5 ]; then
  ...
  if [ ! -f $lang_dir/train.txt ]; then
    gunzip -c $dl_dir/tedlium2/LM/*.en.gz | sed 's: <\/s>::g' > $lang_dir/train_orig.txt
  ...
  if [ ! -f $lang_dir/words.txt ]; then
    ...
    awk '{print $1}' $dl_dir/tedlium2/TEDLIUM.152k.dic |
